...
feat_df=pd.read_csv(curr_dir+'/selected_transcripts/rs932501.txt',sep='\t')
...
stdscaler=pickle.load(open(curr_dir+'/models/rs932501/rs932501_stdscaler.sav', 'rb'))
model=pickle.load(open(curr_dir+'/models/rs932501/rs932501_LR.sav', 'rb'))
...
final_df['sample_id']=['rs932501']
final_df['pred_proba']=pred_prob
final_df.to_csv(curr_dir+'/output_files/rs932501_pred_ouput.txt',index=False,sep='\t')
